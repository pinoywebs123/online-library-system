	...
	<div class="row">
			...
			<div class="row">
				<nav class="navbar navbar-default" id="sideNavs">
						...
						<ul class="nav navbar-pills nav-stacked">
							...
							<li role="presentation" class="active"><a href="<?php echo base_url();?>lib/books"><span class="fa fa-book" id="sideLogo"></span>BOOKS</a></li>
		...
		<div class="row" id="contentMain">
			<div id="studNav">
					...
					<div id="studAdd">
						<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#addBook">Add Book</a>
					</div>
					<div id="studSearch">
						<form>
				...
				<table class="table" id="student">
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo base_url();?>lib/editBook/<?php echo $row->book_id; ?>" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>lib/add_book" method="POST">
...
<div class="modal fade" id="delete">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<a href="<?php echo base_url();?>lib/books/<?php echo $row->book_id;?>" class="btn btn-danger">Yes</a>
				<a href="<?php echo base_url();?>lib/books" class="btn btn-warning">No</a>
			</div>
		</div>
	</div>
</div>
