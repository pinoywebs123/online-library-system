...
<div class="col-md-6 col-md-offset-3" id="loginContent">
	...
	<div class="well" id="loginForm">
		...
		<form action="<?php echo base_url();?>lib/login_parse" method="POST">
			...
			<div id="sideLine" class="form-group">
				...
				<input type="text" name="lib_user" id="lib_user" class="form-control input-lg" id="input_form">
			</div>
			<div id="sideLine" class="form-group">
				<label for="lib_pass">Password</label>
				<input type="password" name="lib_pass" id="lib_pass" class="form-control input-lg" id="input_form">
			</div>
