			...
			<div class="row">
				<nav class="navbar navbar-default" id="sideNavs">
						...
						<ul class="nav navbar-pills nav-stacked">
							<li role="presentation" class="active"><a href="<?php echo base_url(); ?>student/main"><span class="fa fa-home" id="sideLogo"></span>BOOKS</a></li>
				...
				<table class="table" id="student">
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo base_url();?>student/borrow/<?php echo $row->book_id;?>" class="btn btn-info">Borrow</a>
							</td>				
						</tr>
					<?php			
							}
