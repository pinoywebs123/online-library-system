			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
		            <li><a href="<?php echo base_url();?>student/setting">Setting</a></li>
		            <li><a href="<?php echo base_url();?>student">Logout</a></li>
		          </ul>
		        </li>
				<?php 	
					}else {
	...
	<div class="row">
			...
			<div class="row">
				<nav class="navbar navbar-default" id="sideNavs">
						...
						<ul class="nav navbar-pills nav-stacked">
							<li role="presentation"><a href="<?php echo base_url(); ?>student/main"><span class="fa fa-home" id="sideLogo"></span>BOOKS</a></li>
							<li role="presentation"><a href="<?php echo base_url();?>student/pending"><span class="fa fa-pencil-square-o" id="sideLogo"></span>PENDING BOOKS</a></li>
							<li role="presentation"><a href="<?php echo base_url();?>student/borrowed"><span class="fa fa-book" id="sideLogo"></span>BORROWED BOOKS</a></li>
							<li role="presentation"><a href="<?php echo base_url();?>student/activity"><span class="fa fa-pencil-square-o" id="sideLogo"></span>ACTIVITY</a></li>
							<li role="presentation" class="active"><a href="<?php echo base_url(); ?>student/main"><span class="fa fa-home" id="sideLogo"></span>SETTING</a></li>
						</ul>
		...
		<div class="col-md-9 well" id="content">
			...
			<div class="col-md-4 col-md-offset-4 well">
				<form action="<?php echo base_url();?>student/change_password" method="POST">
