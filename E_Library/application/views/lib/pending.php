	...
	<div class="row">
			...
			<div class="row">
				<nav class="navbar navbar-default" id="sideNavs">
						...
						<ul class="nav navbar-pills nav-stacked">
							...
							<li role="presentation" class="active"><a href="<?php echo base_url();?>lib/pending"><span class="fa fa-pencil-square-o" id="sideLogo"></span>PENDING BOOKS</a></li>
		...
		<div class="col-md-9 well" id="content">
			...
			<div class="row" id="contentMain">				
				<div id="studNav">
					<h1 class="text-center">Pending Books to be Borrowed</h1>
					<div id="studSearch">
						<form>
					...
					?>
						<tr>
							...
							<td>
								...
								<a href="<?php echo base_url();?>lib/confirm/<?php echo $row->brw_id;?>" class="btn btn-info">Confirm</a>
								<a href="<?php echo base_url();?>lib/cancel/<?php echo $row->brw_id;?>" class="btn btn-danger">Cancel</a>
							</td>				
						</tr>
					<?php			
							}
