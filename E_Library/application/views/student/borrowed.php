			...
			<div class="row">
				<nav class="navbar navbar-default" id="sideNavs">
						...
						<ul class="nav navbar-pills nav-stacked">
							...
							<li role="presentation" class="active"><a href="<?php echo base_url();?>student/borrowed"><span class="fa fa-book" id="sideLogo"></span>BORROWED BOOKS</a></li>
				...
				<table class="table" id="student">
					...
					?>
						<tr>
							...
							<td><?php echo substr($row->brw_date, 0, 11) . "<strong>" . substr($row->brw_date, 11) ;?></td>
							<td>
								<a href="<?php echo base_url();?>student/return/<?php echo $row->book_id;?>" class="btn btn-info">Return</a>
							</td>				
						</tr>
					<?php			
							}
